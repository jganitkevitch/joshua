...
public class FileUtilityOld {
  ...
  public static void printHashTbl(Map<String, Double[]> tbl, String f_out, boolean key_only,
      boolean vector_value) {
    // #### write hashtable
  ...
  public static void printHashTblAboveThreshold(HashMap<String, Double> tbl, String f_out,
      boolean key_only, double threshold, boolean useZeroValue, boolean addBaselineFeature,
      String baselineFeatureName) {
    // #### write hashtable
    BufferedWriter out = FileUtilityOld.getWriteFileStream(f_out);
    System.out.println("########### write hash table to file " + f_out);
