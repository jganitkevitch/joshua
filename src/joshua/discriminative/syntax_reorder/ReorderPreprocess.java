...
public class ReorderPreprocess {
  ...
  /**
   * by zhifei li@jhu zhifei.work@gmail.com to display chinese: change the locale (as well as
   * format) to Chinese/PRC in regional setting
   */
  ...
  public static void main(String[] args) {
    ...
    // String parse_str = new
    // String("(IP (NP (NN ����) (NN ͳ��)) (VP (VV ����) (PU ,) (IP (IP (NP (NP (NP (PU ��) (NT ����) (PU ��)) (NP (NN �ڼ�))) (NP (NR ())) (VP (NP (NT һ�ž�0��D) (NT һ�ž�����)) (VP (VV ))))) (PU ,) (IP (NP (DNP (NP (NP (NR �й�)) (NP (NN ����) (NN Ͷ��) (NN ��ҵ))) (DEG ��)) (NP (NN ����))) (VP (VV ��) (NP (CP (IP (VP (NP (NN ֱ��)) (VP (VV ����)))) (DEC ֮)) (NP (NN ��))))) (PU ,) (IP (NP (NN ���)) (VP (ADVP (AD ���)) (VP (VV ��) (QP (CD �ٷ�֮��ʮ����))))) (PU ,) (IP (NP (NN ���)) (VP (ADVP (AD ���)) (VP (VV ��) (QP (CD �ٷ�֮��ʮ�˵���))))))) (PU ��))");
    // String parse_str = new
    // String("(FRAG (NR ֮��) (NR biejing) (NT er) (NT 1) (NN dian) (PU () (NN jizhe) (NR tangn) (PU )))");

    // BufferedReader f_rules =
    // FileUtility.getReadFileStream("C:\\data_disk\\java_work_space\\PhraseExtraction\\phraseExtraction\\cn_reordering_rules.txt","UTF8");
    BufferedReader f_rules = FileUtilityOld.getReadFileStream(args[0].trim(), "UTF8");

    // BufferedReader t_reader_tree =
    // FileUtility.getReadFileStream("C:\\data_disk\\java_work_space\\PhraseExtraction\\phraseExtraction\\manual_align.txt.word.cn.parsed","UTF8");
    // BufferedReader t_reader_tree =
    // FileUtility.getReadFileStream("C:\\data_disk\\java_work_space\\PhraseExtraction\\phraseExtraction\\corpus.zh.parsed","UTF8");
    BufferedReader t_reader_tree = FileUtilityOld.getReadFileStream(args[1].trim(), "UTF8");

    // BufferedWriter t_writer_tree =
    // FileUtility.getWriteFileStream("C:\\data_disk\\java_work_space\\PhraseExtraction\\phraseExtraction\\manual_align.txt.word.cn.tree.reordered","UTF8");
    BufferedWriter t_writer_tree = FileUtilityOld.getWriteFileStream(args[2].trim(), "UTF8");

    // BufferedWriter t_writer_flat =
    // FileUtility.getWriteFileStream("C:\\data_disk\\java_work_space\\PhraseExtraction\\phraseExtraction\\manual_align.txt.word.cn.flat.reordered","UTF8");
    ...
    while ((parse_str = FileUtility.read_line_lzf(t_reader_tree)) != null) {
      // parse_str = new
      // String("( (IP (NP (NP (NR ��-��)) (NP (NN ��2�) (NN ��Ա))) (VP (VV ˵) (PU ,) (IP (IP (NP (CP (IP (NP (DNP (NP (ADJP (JJ ���)) (NP (NN ����))) (DEG ��)) (NP (NN �ɻ�))) (VP (NP (NP (NT 13��)) (NP (NN ����) (NN ʱ��)) (NT �賿) (NT 4��)) (VP (VV Ͷ��)))) (DEC ��)) (QP (CD }) (CLP (M ö))) (NP (NN ����) (CC ��) (NN ը��))) (PU ,) (VP (VV ����) (NP (QP (CD һ) (CLP (M ��))) (ADJP (JJ ����)) (NP (NN ����)) (ADJP (JJ �?�)) (NP (NN ����))))) (PU ,) (IP (NP (CP (IP (VP (VV ��) (PP (P ��) (NP (NN ����))))) (DEC ��)) (QP (ADVP (AD ����)) (QP (CD 500) (CLP (M ��)))) (NP (NN ƽ��))) (VP (SB ��) (VP (VV ը��)))) (PU ,) (IP (NP (NN ����)) (VP (ADVP (AD ���)) (VP (VC ��) (NP (NN ��Ů) (CC ��) (NN ��ͯ))))))) (PU ��)))");
  ...
  private void reorder_node(TreeNode root, Hashtable rules_tbl) {// root is the root of the current
                                                                 // sub-tree
    if (root.name.compareTo("fake_root") != 0 && root.name.compareTo("") != 0
        && root.children.size() > 1) {// not the fake root, nor fake node, must have more than two
                                      // children
      if (rules_tbl.containsKey(root.name)) {// in the rules_tbl, have rules with the lhs as
                                             // root.name
        ...
        for (int i = 0; i < t_rules.size(); i++) {// try to match each rule
          ...
          if (rule.reorder(root) == true) // TODO: now, we just reorder the node based on the first
                                          // match, need to reconsider
            break;
        }
      }
    }
  ...
  private Hashtable setup_rules_tbl(BufferedReader f_rules) {
    ...
    String rule_str = "";
    while ((rule_str = FileUtility.read_line_lzf(f_rules)) != null) {// //( (FRAG (NR �»���) (NR
                                                                     // ����) (NT ����) (NT ʮһ��)
                                                                     // (NN ��) (PU () (NN ����) (NR
                                                                     // �ƺ�) (PU ))))
