...
public class ReorderRule {
  ...
  public ReorderRule(String rule_str) {
    ...
    tgt_order = fds[2].split("\\s+");// TODO: assume the chinese words does not have x0, x1, and so
                                     // on
  ...
  public boolean reorder(TreeNode tree_node) {// tree_node: the node of the parsing tree of the
                                              // source sentence
