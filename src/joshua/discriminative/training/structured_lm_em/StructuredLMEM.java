...
public class StructuredLMEM extends DefaultEM {
  ...
  public void runOneEMStep(int iterNum) {
    p_decoder.decodingTestSet(trainingFile, outGrammarPrefix + "." + iterNum); // call decoder to
                                                                               // run EM
  }
  ...
  public static void main(String[] args) {
    ...
    if (args.length < 4) {
      System.out
          .println("Wrong number of parameters, it must have at least two parameters: java StructuredLMEM f_joshua_config f_train");
      System.exit(1);
    }
    ...
    DefaultEM p_trainer =
        new StructuredLMEM(maxNumIter, relativeLikelihoodThreshold, maxConvergeNum,
            f_joshua_config, f_dev_src, outGrammarPrefix);
    p_trainer.runEM();
  }
}
