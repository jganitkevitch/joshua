...
public class FeatureSelectionNBEST {
  ...
  public static void main(String[] args) {
    ...
    if (args.length != 2) {
      System.out
          .println("wrong command, correct command should be: java FeatureSelection_NBEST f_l_test_nbest f_feature_set_out");
    ...
    for (int fid = 0; fid < testNbestFiles.size(); fid++) {
      ...
      BufferedReader t_reader_nbest =
          FileUtilityOld.getReadFileStream((String) testNbestFiles.get(fid), "UTF-8");
      String line = null;
