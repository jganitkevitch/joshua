...
public class HGProducer extends Producer<HGAndReferences> {
  ...
  private static final Logger logger = Logger.getLogger(HGProducer.class.getName());

  public HGProducer(HyperGraphFactory hgFactory, BlockingQueue<HGAndReferences> q,
      int numConsumers, int maxSentID) {
