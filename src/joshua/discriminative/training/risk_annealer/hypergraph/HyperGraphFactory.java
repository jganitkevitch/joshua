...
public class HyperGraphFactory {
  ...
  private static final Logger logger = Logger.getLogger(HyperGraphFactory.class.getName());

  public HyperGraphFactory(String diskHGFilePrefix, String[] referenceFiles, int ngramStateID,
      boolean readReferences) {
  ...
  private void initDiskReading() {
    ...
    diskHG = new DiskHyperGraph(ngramStateID, true, null); // have model costs stored
