...
public class JoshuaNbestMinRiskDAMert extends NbestMinRiskDAMert {
  ...
  public JoshuaNbestMinRiskDAMert(boolean useShortestRef, String joshuaConfig, String devSrcFile,
      int numSentInDevSet, String[] refFiles, String nbestPrefix) {
  ...
  public void decodingTestSet(double[] weights, String nbestFile) {
    ...
    joshuaDecoder.decodeTestSet(sourceTrainingFile, nbestFile); // call Joshua decoder to produce an
                                                                // nbest using the new weight vector
  }
  ...
  public static void main(String[] args) {
    /*
     * String f_joshua_config=
     * "C:/data_disk/java_work_space/discriminative_at_clsp/edu/jhu/joshua/discriminative_training/lbfgs/example.config.javalm"
     * ; String f_dev_src="C:/data_disk/java_work_space/sf_trunk/example/example.test.in"; String
     * f_nbest_prefix=
     * "C:/data_disk/java_work_space/discriminative_at_clsp/edu/jhu/joshua/discriminative_training/lbfgs/example.nbest.javalm.out"
     * ; String f_dev_ref="C:/data_disk/java_work_space/sf_trunk/example/example.test.ref.0";
     */
    if (args.length < 5) {
      System.out
          .println("Wrong number of parameters, it must have at least four parameters: java NbestMinRiskAnnealer use_shortest_ref f_joshua_config gain_factor f_dev_src f_nbest_prefix f_dev_ref1 f_dev_ref2....");
      System.exit(1);
    }
    ...
    NbestMinRiskDAMert trainer =
        new JoshuaNbestMinRiskDAMert(useShortestRef, joshuaConfig, devSrcFile, numSentInDevSet,
            refFiles, nbestPrefix);
    trainer.mainLoop();
  }
