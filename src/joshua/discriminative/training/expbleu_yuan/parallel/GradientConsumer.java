...
public class GradientConsumer extends Consumer<HGAndReferences> {
  ...
  public GradientConsumer(BlockingQueue<HGAndReferences> q, List<FeatureTemplate> featTemplates,
      HashMap<String, Integer> featureStringToIntegerMap, double[] theta,
      ExpbleuGradientComputer expbleuGradientComputer) {
    super(q);
  ...
  public void consume(HGAndReferences x) {
    ...
    ExpbleuSemiringParser parser =
        new ExpbleuSemiringParser(x.referenceSentences, this.featTemplates,
