...
public class VariationalDecoderMinRiskMert extends NbestMinRiskDAMert {
  ...
  public static void main(String[] args) {
    ...
    NbestMinRiskDAMert p_trainer =
        new VariationalDecoderMinRiskMert(use_shortest_ref, f_config, f_dev_items, f_dev_rules,
            num_sent_in_dev_set, f_dev_refs, f_nbest_prefix);
    p_trainer.mainLoop();
  }


  public VariationalDecoderMinRiskMert(boolean use_shortest_ref_, String f_config_,
      String f_dev_items_, String f_dev_rules_, int number_sent_, String[] f_dev_refs_,
      String f_nbest_prefix_) {
  ...
  public void decodingTestSet(double[] weights, String f_nbest) {
    ...
    p_decoder.decodingTestSet(f_dev_items, f_dev_rules, num_dev_sents, f_nbest); // call decoder to
                                                                                 // produce an nbest
                                                                                 // using the new
                                                                                 // weight vector
  }
