...
public class ConfigFileConverter {
  ...
  public static List<Double> readGoogleWeightsFromJoshuaConfig(String joshuaConfig)
      throws IOException {
  ...
  static public void convertJoshuaToMertFormat(String joshuaConfig, String mertConfigTemplate,
  ...
  static public void convertMertToJoshuaFormat(String mertConfig, String joshuaConfigTemplate,
      String outputFile) throws IOException {
