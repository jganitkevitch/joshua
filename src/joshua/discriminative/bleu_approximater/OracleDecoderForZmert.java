...
public class OracleDecoderForZmert {
  ...
  private static final Logger logger = Logger.getLogger(OracleDecoderForZmert.class.getName());
  ...
  public static void main(String[] args) throws IOException {
    ...
    // ============== convert config file
    ConfigFileConverter.convertMertToJoshuaFormat(joshuaConfigForZmert, joshuaConfigTempalte,
        trueJoshuaConfigFile);
    ...
    List<Double> googleWeights =
        ConfigFileConverter.readGoogleWeightsFromJoshuaConfig(trueJoshuaConfigFile);
