...
public class FeatureSelectionHG {
  ...
  public static void main(String[] args) {
    ...
    if (args.length < 8) {
      System.out
          .println("wrong command, correct command should be: java FeatureSelection f_l_test_items f_l_test_rules f_l_num_sents use_tm_feat use_lm_feat use_edge_ngram_only use_joint_tm_lm_feature f_feature_set_out [threshold]");
    ...
    for (int fid = 0; fid < testItemsFiles.size(); fid++) {
      ...
      DiskHyperGraph dhg_train = new DiskHyperGraph(ngramStateID, saveModelScore, null);
    ...
    FileUtilityOld.printHashTblAboveThreshold(tbl_feats, f_feature_set_out, keyOnly, threshold,
        useZeroValue, addBaselineFeature, baselineFeatureName);
