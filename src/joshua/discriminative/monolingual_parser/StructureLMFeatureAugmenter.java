...
public class StructureLMFeatureAugmenter {
  public static void main(String[] args) throws IOException {
    /*
     * String bilingualGrammarFile =
     * "C:\\data_disk\\java_work_space\\sf_trunk\\example\\example.hiero.tm.gz"; String
     * monolingualGrammarFile =
     * "C:\\data_disk\\java_work_space\\sf_trunk\\example\\example.hiero.mono.tm";
     */
    if (args.length < 3) {
      System.out
