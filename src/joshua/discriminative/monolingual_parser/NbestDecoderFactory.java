...
public class NbestDecoderFactory extends MonolingualDecoderFactory {
  ...
  public NbestDecoderFactory(GrammarFactory[] grammar_facories, boolean have_lm_model_,
  ...
  public MonolingualDecoderThread constructThread(int decoderID, String cur_test_file,
    ...
    MonolingualDecoderThread pdecoder =
        new NbestDecoderThread(this.p_grammar_factories, this.have_lm_model,
            this.p_l_feat_functions, this.l_default_nonterminals, cur_test_file, cur_nbest_file,
            start_sent_id);
    return pdecoder;
  }
  ...
  public void mergeParallelDecodingResults() throws IOException {
    ...
    if (JoshuaConfiguration.save_disk_hg) {
      t_writer_dhg_items = FileUtility.getWriteFileStream(nbestFile + ".hg.items");
    }
