...
public class NbestDecoderThread extends MonolingualDecoderThread {
  ...
  public NbestDecoderThread(GrammarFactory[] grammar_factories, boolean have_lm_model_,
      ArrayList<FeatureFunction> l_feat_functions, ArrayList<Integer> l_default_nonterminals_,
      String test_file_in, String nbest_file_in, int start_sent_id_in) throws IOException {
    super(grammar_factories, have_lm_model_, l_feat_functions, l_default_nonterminals_,
        test_file_in, start_sent_id_in);
    ...
    this.kbestExtractor =
        new KBestExtractor(JoshuaConfiguration.use_unique_nbest,
            ...
            JoshuaConfiguration.add_combined_cost, true, true);
  ...
  public void postProcessHypergraph(HyperGraph p_hyper_graph, int sentenceID) throws IOException {
    ...
    kbestExtractor.lazyKBestExtractOnHG(p_hyper_graph, featFunctions, JoshuaConfiguration.topN,
        sentenceID, t_writer_nbest);
  }
