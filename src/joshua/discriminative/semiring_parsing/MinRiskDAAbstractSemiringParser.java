...
/**
 * small scale: use a list at each node, the dense feature vector has already been stored at each
 * hyperedge large scale: use a hashmap at each node, and extract the sparse features from each edge
 * on the fly
 **/
