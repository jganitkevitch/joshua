...
/**
 * This class implements Table-1 in the emnlp paper (Li and Eisner, 2009), in the general setting of
 * sec 4.1.
 * */
...
public class ExpectationSemiring<P extends Semiring<P>, R extends PModule<P, R>>
    implements
      Semiring<ExpectationSemiring<P, R>> {
  ...
  public void setToOne() {
    ...
    /**
     * Note that r should always set as zero. For example, when the r is expected length, it should
     * start from zero
     * */
    this.r.setToZero();
  }
