...
/**
 * PModule where P is an expectation semiring This implements the "lift" trick in Sec 4.3 of (Li and
 * Eisner, 2009)
 */
...
public class ExpectationSemiringPM<P extends Semiring<P>, R extends PModule<P, R>, S extends PModule<P, S>, T extends PModule<P, T>, BO extends BilinearOperator<R, S, T>>
    implements
      PModule<ExpectationSemiring<P, R>, ExpectationSemiringPM<P, R, S, T, BO>> {
  S sValue;
  T tValue;
